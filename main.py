...
class TreeCalc(QMainWindow):
    def __init__(self):
        ...
        self.ui.bnt_add_wanted.clicked.connect(self.add_wanted_skill)
        ...
        self.ui.bnt_add_unwanted.clicked.connect(self.add_unwanted_skill)
    ...
    def build_chosen_tree(self):
        ...
        self.ui.cmb_skill3.setCurrentIndex(0)
        self.ui.cmb_skill3_level.setCurrentIndex(0)
        self.ui.cmb_skill4.setCurrentIndex(0)
        self.ui.cmb_skill4_level.setCurrentIndex(0)
        self.ui.cmb_skill5.setCurrentIndex(0)
        self.ui.cmb_skill5_level.setCurrentIndex(0)
        self.ui.cmb_skill6.setCurrentIndex(0)
        self.ui.cmb_skill6_level.setCurrentIndex(0)
        self.ui.cmb_skill7.setCurrentIndex(0)
        self.ui.cmb_skill7_level.setCurrentIndex(0)
        self.ui.cmb_skill8.setCurrentIndex(0)
        self.ui.cmb_skill8_level.setCurrentIndex(0)
    ...
    def add_wanted_skill(self):
        ...
        items_text = []
        for index in range(self.ui.lw_wanted_skills.count()):
            item = self.ui.lw_wanted_skills.item(index)
            items_text.append(item.text()[:-1])
    ...
    def add_unwanted_skill(self):
        skill = self.ui.cmb_wanted_unwanted.currentText()
        items_text = []
        for index in range(self.ui.lw_unwanted_skills.count()):
            item = self.ui.lw_unwanted_skills.item(index)
    ...
    def add_banned_skill(self):
        ...
        items_text = []
        for index in range(self.ui.lw_banned_skills.count()):
            item = self.ui.lw_banned_skills.item(index)
            items_text.append(item.text())
    ...
    def find_trees(self):
        ...
        for tree_num in corr_trees:
            ...
            tree_text.append(f'{tree_num} {next_l.chosen_skill[:7]} {next_r.chosen_skill[:7]}')

        for elem in tree_text:
            self.ui.lw_tree_numbers.addItem(elem)
